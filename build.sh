...
clang++-17 BSAT.cpp -g -std=c++20 -march=native -fopenmp -ljemalloc -ltbb -o bin/BSAT-Debug
clang++-17 BSAT.cpp -ggdb3 -O3 -DNDEBUG -funroll-loops -ffast-math -march=native \
